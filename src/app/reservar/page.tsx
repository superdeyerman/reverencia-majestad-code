...
export default async function ReservasPage({
  ...
  const preselectedSlug =
    typeof servicioParam === 'string' ? servicioParam : null;

  const [servicios, testimonialAgg, completedCount] = await Promise.all([
  ...
  return (
    <main className="bg-[#f8f4ed]">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-6 py-16 lg:grid-cols-[1.08fr_0.92fr] lg:px-12 lg:py-20">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-stone-600 sm:text-lg">
              ...
              transparente, abono seguro por Mercado Pago y acompañamiento humano.
            </p>
      ...
      <section
        id="wizard"
        className="mx-auto max-w-7xl scroll-mt-24 px-6 py-14 lg:px-10"
      >
        <BookingWizard
          services={servicios}
